...
\begin{itemize}
    ...
    \item \textbf{NotebookLM:} Se ha utilizado NotebookLM para la creación de las imágenes utilizadas para la portada. \href{https://notebooklm.google.com}{Enlace a NotebookLM}
\end{itemize}
